...
const signInSubmit = () => {
  ...
  if (userpassword.value === "") {
    ...
    if (ValidateEmail(useremail) === true && CheckPassword(userpassword) === true) { alert("Giriş başarılı") }
};
...
const closeEmailWarn = () => {
  emailwarn.style.display = 'none';
  ValidateSignupEmail(signupmail)
}
...
function CheckSignUpCtrlPassword() {
...
const closePassCtrlWarn = () => {
  passcontwarn.style.display = 'none';
  PassMatch()
  CheckSignUpCtrlPassword();
}
